...
-- }
MineImages = {
    blockImage = love.graphics.newImage("resource/mineAtlas.png"),
    boardImage = love.graphics.newImage("original_resource/mine_board.png"),
    num0Image = love.graphics.newImage("resource/mineAtlas.png"),
    num1Image = love.graphics.newImage("resource/mineAtlas.png"),
    num2Image = love.graphics.newImage("resource/mineAtlas.png"),
    num3Image = love.graphics.newImage("resource/mineAtlas.png"),
    num4Image = love.graphics.newImage("resource/mineAtlas.png"),
    num5Image = love.graphics.newImage("resource/mineAtlas.png"),
    num6Image = love.graphics.newImage("resource/mineAtlas.png"),
    num7Image = love.graphics.newImage("resource/mineAtlas.png"),
    num8Image = love.graphics.newImage("resource/mineAtlas.png"),
    flagImage = love.graphics.newImage("resource/mineAtlas.png"),
    mineImage = love.graphics.newImage("resource/mineAtlas.png"),
    mineCellWidth = 40,
    mineCellHeight = 40,
