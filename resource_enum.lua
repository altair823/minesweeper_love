local mineImages = {
    ...
    num1Image = love.graphics.newImage("resource/mine_cell.png"),
    num2Image = love.graphics.newImage("resource/mine_cell.png"),
    num3Image = love.graphics.newImage("resource/mine_cell.png"),
    num4Image = love.graphics.newImage("resource/mine_cell.png"),
    num5Image = love.graphics.newImage("resource/mine_cell.png"),
    num6Image = love.graphics.newImage("resource/mine_cell.png"),
    num7Image = love.graphics.newImage("resource/mine_cell.png"),
    num8Image = love.graphics.newImage("resource/mine_cell.png"),
...
mineAtlas = {
    ...
    cellAtlas = {
        ...
        [MineEnum.ONE] = {image = mineImages.num1Image, quad = love.graphics.newQuad(160, 0, 32, 32, mineImages.num1Image)},
        [MineEnum.TWO] = {image = mineImages.num2Image, quad = love.graphics.newQuad(192, 0, 32, 32, mineImages.num2Image)},
        [MineEnum.THREE] = {image = mineImages.num3Image, quad = love.graphics.newQuad(224, 0, 32, 32, mineImages.num3Image)},
        [MineEnum.FOUR] = {image = mineImages.num4Image, quad = love.graphics.newQuad(256, 0, 32, 32, mineImages.num4Image)},
        [MineEnum.FIVE] = {image = mineImages.num5Image, quad = love.graphics.newQuad(288, 0, 32, 32, mineImages.num5Image)},
        [MineEnum.SIX] = {image = mineImages.num6Image, quad = love.graphics.newQuad(320, 0, 32, 32, mineImages.num6Image)},
        [MineEnum.SEVEN] = {image = mineImages.num7Image, quad = love.graphics.newQuad(352, 0, 32, 32, mineImages.num7Image)},
        [MineEnum.EIGHT] = {image = mineImages.num8Image, quad = love.graphics.newQuad(384, 0, 32, 32, mineImages.num8Image)},
    },
    buttonAtlas = {
