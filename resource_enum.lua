MineImages = {
    blockImage = love.graphics.newImage("original_resource/mine_block.png"),
    boardImage = love.graphics.newImage("original_resource/mine_board.png"),
    num0Image = love.graphics.newImage("original_resource/mine_num0.png"),
    ...
    flagImage = love.graphics.newImage("original_resource/mine_flag.png"),
    mineImage = love.graphics.newImage("original_resource/mine_mine.png"),
    mineCellWidth = 32,
    mineCellHeight = 32,
